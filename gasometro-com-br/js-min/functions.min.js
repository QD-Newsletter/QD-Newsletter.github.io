        ...
        e.validate({
            ...
            submitHandler: function(e) {
                ...
                if (a.valid()) {
                    ...
                    var t = function(e) {
                        ...
                        var o = a.serializeObject(), t = function(t) {
                            o.userId = e, o.ip = t, o.id = (n.val() || "").toLowerCase().replace(/[^a-z0-9]/gi, function(e) {
                                ...
                                url: "//api.vtexcrm.com.br/madeirasgasometro/dataentities/NL/documents",
                                type: "PATCH",
                                dataType: "json",
                                headers: {
                    ...
                    return $.ajax({
                        url: "//api.vtexcrm.com.br/madeirasgasometro/dataentities/CL/search?_fields=id&email=" + (n.val() || "---"),
                        type: "GET",
                        dataType: "json",
                        headers: {
                            Accept: "application/vnd.vtex.ds.v10+json"
